      ...
      <div className="container mx-auto px-6">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a
              href="/resume.pdf"
              className="border border-emerald-400 bg-teal-400/10 text-emerald-400 px-4 py-2 transform translate-x-7 rounded-full hover:bg-emerald-400/10 transition-colors"
            >
              Resume
            </a>
          </div>
